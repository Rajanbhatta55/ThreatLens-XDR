...
<div class="container">
    <header>
        ...
        <div class="sub">{html.escape(date_label)} - {len(alerts)} alert(s) from {total_events:,} events</div>
    </header>
    ...
    <div class="legend">
        ...
        <span><span class="dot" style="background:{_SEVERITY_COLORS[Severity.INFO]};"></span>INFO</span>
    </div>
    ...
    <footer>Generated by ThreatLens v{__version__} - {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}</footer>
</div>
