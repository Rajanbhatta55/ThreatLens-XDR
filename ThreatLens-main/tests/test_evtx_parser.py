...
<Event xmlns="http://schemas.microsoft.com/win/2004/08/events/event">
  <System>
    ...
    <TimeCreated SystemTime="2026-01-15T08:30:01Z"/>
...
<Event xmlns="http://schemas.microsoft.com/win/2004/08/events/event">
  <System>
    ...
    <TimeCreated SystemTime="2026-03-10T07:10:00Z"/>
...
class TestParseEvtxRecord:
    ...
    def test_parse_with_missing_fields(self):
        record_dict = {"EventID": "4688", "TimeCreated": "2026-01-15T09:00:00Z"}
        event = _parse_evtx_record(record_dict)
    ...
    def test_parse_invalid_event_id(self):
        record_dict = {"EventID": "abc", "TimeCreated": "2026-01-15T09:00:00Z"}
        event = _parse_evtx_record(record_dict)
    ...
    def test_get_reads_from_top_level(self):
        ...
        record_dict = {
            "EventID": "4624",
            "TimeCreated": "2026-01-15T09:00:00Z",
            "Source": "Security",
            "Computer": "WS-01",
